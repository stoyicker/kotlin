...
public class IrJsCodegenBoxTestGenerated extends AbstractIrJsCodegenBoxTest {
    ...
    @TestDataPath("$PROJECT_ROOT")
    @RunWith(JUnit3RunnerWithInners.class)
    public static class GenericTypeReturnNullCheck extends AbstractIrJsCodegenBoxTest {
        private void runTest(String testDataFilePath) throws Exception {
            KotlinTestUtils.runTest0(this::doTest, TargetBackend.JS_IR, testDataFilePath);
        }

        public void testAllFilesPresentInGenericTypeReturnNullCheck() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("compiler/testData/codegen/box/genericTypeReturnNullCheck"), Pattern.compile("^(.+)\\.kt$"), TargetBackend.JS_IR, true);
        }

        @TestMetadata("compiler/testData/codegen/box/genericTypeReturnNullCheck/callSite")
        @TestDataPath("$PROJECT_ROOT")
        @RunWith(JUnit3RunnerWithInners.class)
        public static class CallSite extends AbstractIrJsCodegenBoxTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest0(this::doTest, TargetBackend.JS_IR, testDataFilePath);
            }

            public void testAllFilesPresentInCallSite() throws Exception {
                KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("compiler/testData/codegen/box/genericTypeReturnNullCheck/callSite"), Pattern.compile("^(.+)\\.kt$"), TargetBackend.JS_IR, true);
            }
        ...
        public static class Delegation extends AbstractIrJsCodegenBoxTest {
            ...
            public void testAllFilesPresentInDelegation() throws Exception {
                KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("compiler/testData/codegen/box/genericTypeReturnNullCheck/delegation"), Pattern.compile("^(.+)\\.kt$"), TargetBackend.JS_IR, true);
            }

            @TestMetadata("simpleDelegation.kt")
            public void testSimpleDelegation() throws Exception {
                runTest("compiler/testData/codegen/box/genericTypeReturnNullCheck/delegation/simpleDelegation.kt");
            }
        }
    }
